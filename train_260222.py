...
class Config:
    ...
    LR = 1e-4
    EPOCHS = 100
    CLASS_NAMES = ["book_1", "book_2", "book_3", "book_4", "eraser_2", "eraser_3", "eraser_4", "notebook_1", "notebook_2", "notebook_3", "notebook_4", "pen_1", "pen_2", "pen_3", "pen_4"] # 클래스 이름 배열
    NUM_CLASSES = len(CLASS_NAMES)
    LEARNING_DATA_RATIO = 0.8  # 학습 데이터 비율 (0.8 = 80%)
    MODEL_PATH = os.path.join(OUTPUT_DIR, "best_model.pth")  # 기존 모델 경로
...
def main():
    ...
    early_stopping = EarlyStopping(patience=10, min_delta=0.001, verbose=True)  # EarlyStopping 객체 생성
