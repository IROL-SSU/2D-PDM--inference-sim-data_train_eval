...
이 프로젝트는 비상업적 사용만 허용하는 [Non-Commercial Source License](LICENSE)를 따릅니다. 연구, 교육, 평가, 개인 학습 목적의 사용은 허용되지만, 상업적 제품·유료 서비스·수익 창출 활동·내부 업무 활용 등 상업적 이용은 사전 서면 허가 없이 금지됩니다.
